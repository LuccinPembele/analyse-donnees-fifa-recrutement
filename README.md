...
1. Comprendre les facteurs de performance qui différencient les joueurs.
2. Identifier et détecter des jeunes talents à partir d'attributs clés.
...
* Concentrer le scouting sur les championnats majeurs comme la Premier League(Angleterre) et LALIGA (Espagne), qui regroupent la plus forte densité de talents de haut niveau.
* Prioriser le recrutement de jeunes joueurs dotés d'une excellente qualité de dribble et d'une vitesse élevée pour dynamiser le jeu de transition.

### Détection de Jeunes Talents
Grâce aux scores de performance calculés par poste, le modèle met en lumière des pépites à fort potentiel à intégrer en priorité dans les cellules de recrutement, telles que :
* Vitor Roque
* Mathys Tel
